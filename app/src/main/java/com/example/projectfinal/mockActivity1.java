...
public class mockActivity1 extends AppCompatActivity implements View.OnClickListener{
    ...
    public void onClick(View v) {
        ...
        if(clickButton.getId() == R.id.submitBtn) {
            if (selectedAnswer.equals(questionAnswer1.correctAnswer[currentQuestionIndex])) {
                score++;
            }
    ...
    void showCurrentSolution(){
        ...
        solution.setText(questionAnswer1.desAns[currentAnswerIndex]);
        showAns.setVisibility(View.VISIBLE);
    }
    void showNextSolution(){
        currentAnswerIndex = (currentAnswerIndex + 1) % questionAnswer1.desAns.length;
        solution.setVisibility(View.INVISIBLE);
        showCurrentSolution();
    ...
    void loadNewQuestion(){
        ...
        opt1.setText(questionAnswer1.choices[currentQuestionIndex][0]);
        opt2.setText(questionAnswer1.choices[currentQuestionIndex][1]);
        opt3.setText(questionAnswer1.choices[currentQuestionIndex][2]);
        opt4.setText(questionAnswer1.choices[currentQuestionIndex][3]);
    }
