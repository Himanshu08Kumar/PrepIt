...
import static com.example.projectfinal.boats.correctAnswer;
...
public class aptiActivity7 extends AppCompatActivity implements View.OnClickListener{
    ...
    int score = 0;
    int totalQuestion = boats.question.length;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_apti8);
    ...
    public void onClick(View v) {
        ...
        if(clickButton.getId() == R.id.submitBtn) {
            if (selectedAnswer.equals(boats.correctAnswer[currentQuestionIndex])) {
                score++;
            }
        ...
        void showCurrentSolution(){
            ...
            solution.setText(boats.desAns[currentAnswerIndex]);
            showAns.setVisibility(View.VISIBLE);
            }
        void showNextSolution(){
                currentAnswerIndex = (currentAnswerIndex + 1) % boats.desAns.length;
                 solution.setVisibility(View.INVISIBLE);
                showCurrentSolution();
    ...
    void loadNewQuestion(){
        ...
        questionTextView.setText(boats.question[currentQuestionIndex]);
        opt1.setText(boats.choices[currentQuestionIndex][0]);
        opt2.setText(boats.choices[currentQuestionIndex][1]);
        opt3.setText(boats.choices[currentQuestionIndex][2]);
        opt4.setText(boats.choices[currentQuestionIndex][3]);
    }
