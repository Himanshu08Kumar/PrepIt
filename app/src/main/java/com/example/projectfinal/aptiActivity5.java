...
public class aptiActivity5 extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_apti6);
    ...
    void loadNewQuestion(){
        ...
        questionTextView.setText(calendar.question[currentQuestionIndex]);
        opt1.setText(calendar.choices[currentQuestionIndex][0]);
        opt2.setText(calendar.choices[currentQuestionIndex][1]);
